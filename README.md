...
The zipped plugin can be downloaded directly https://github.com/a8cteam51/simple-cpt-press/blob/trunk/simple-cpt-press.zip or from trunk, and installed in the WordPress admin panel
